...
<video muted playsInline preload="auto" autoPlay loop className="rounded-md" style={{ maxWidth: '100%', height: 'auto' }}>
  <source src="/videos/follow-target.mp4" type="video/mp4" />
...
<div className="border border-gray-200 rounded-md mb-3.5">
<video muted playsInline preload="auto" autoPlay loop className="rounded-md" style={{ maxWidth: '100%', height: 'auto' }}>
  <source src="/videos/panning.mp4" type="video/mp4" />
  Your browser does not support the video.
</video>
</div>
...
<div className="border border-gray-200 rounded-md mb-3.5">
<video muted playsInline preload="auto" autoPlay loop className="rounded-md" style={{ maxWidth: '100%', height: 'auto' }}>
  <source src="/videos/zooming.mp4" type="video/mp4" />
  Your browser does not support the video.
</video>
</div>
