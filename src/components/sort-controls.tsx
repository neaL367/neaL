  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
      ...
      <div className="flex gap-2">
        <Button
          variant={sortBy === "newest" || sortBy === "oldest" ? "default" : "outline"}
          size="sm"
        ...
        <Button
          variant={sortBy === "most-likes" || sortBy === "least-likes" ? "default" : "outline"}
          size="sm"
          onClick={() => setSortBy(sortBy === "most-likes" ? "least-likes" : "most-likes")}
        >
          Likes
