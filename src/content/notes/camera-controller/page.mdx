...
<div className="border border-gray-200 rounded-md mb-3.5">
  <Image src={Thumbnail} alt="Camera Following" className="rounded-lg" loading="lazy" placeholder="blur" quality={90} />
</div>
...
<div className="border border-gray-200 rounded-md mb-3.5">
  <Image src={Placeholder} alt="Camera Panning" className="rounded-lg" loading="lazy" placeholder="blur" quality={90} />
</div>
...
<div className="border border-gray-200 rounded-md mb-3.5">
  <Image src={Placeholder} alt="Camera Zooming" className="rounded-lg" loading="lazy" placeholder="blur" quality={90} />
</div>
...
<div className="border border-gray-200 rounded-md mb-3.5">
  <Image src={Placeholder} alt="Camera Rotation" className="rounded-lg" loading="lazy" placeholder="blur" quality={90} />
</div>
