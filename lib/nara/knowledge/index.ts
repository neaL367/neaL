...
const EXTRA_CONCEPT_ALIASES: Record<string, string[]> = {
  ...
  'gta-v': ['gta 5', 'gta five', 'the newest gta'],
  'gta-iv': ['gta 4', 'gta four'],
  ...
  'red-dead-redemption': ['john marston', 'rdr 1'],
