...
[Visit RockstarGames](https://www.rockstargames.com)

<div className="border border-gray-200 rounded-md shadow-md mb-6">
  <Image className="w-full h-full rounded-md " src={placeholder} alt="placeholder" placeholder="blur" />
</div>
...
<Button className="mb-3">This is a React Component</Button>
