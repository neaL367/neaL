...
<summary className="text-gray-600 text-[15px] mb-2">Side Projects</summary>
...
<details className="mb-1 -mt-2">
<summary className="text-gray-600 text-[15px] mb-2">Recent Angular Project</summary>
...
<details className="mb-1 -mt-2">
<summary className="text-gray-600 text-[15px] mb-2">Content Collections</summary>
